...
import com.quote.cowtit.Common.Urls;
import com.quote.cowtit.Common.Utils;
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            try {
                                ...
                                if (status.equalsIgnoreCase("success")) {
                                    ...
                                    Log.i(TAG, "In [MainLogin] :: [Calling CreateSession] :: id :: " + id);
                                    Log.i(TAG, "In [MainLogin] :: [Calling CreateSession] :: emailId :: " + emailId);
                            ...
                            public void onResponse(JSONObject response) {
                                ...
                                try {
                                    ...
                                    if (message.equalsIgnoreCase("User Registered") || message.contains("already registered")) {
                                        ...
                                        //login with fb
                                        userLoginWithFB(id, emailId); // hit login service and save the session
                                    } else {
...
//                                }
    ...
    private void userLoginWithFB(String id, String emailId){
