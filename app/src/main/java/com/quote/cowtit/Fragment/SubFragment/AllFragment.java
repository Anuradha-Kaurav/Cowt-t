...
public class AllFragment extends Fragment {
    ...
    @BindView(R.id.ser_all)
    EditText serAll;
    @BindView(R.id.btn_ser_all)
    Button btnSerAll;
    @BindView(R.id.list_all)
    RecyclerView listAll;
    Unbinder unbinder;
    ArrayList<AllPostPOJO> allPostPOJOS = new ArrayList<>() ;
String url = "http://uservission.com/cw/SearchInAll.php";
    ...
    @OnClick(R.id.btn_ser_all)
    public void onViewClicked() {
        String serch = serAll.getText().toString();
        if(serch.isEmpty()){
            serAll.setFocusable(true);
        }else {
  ...
  public class   ReqSearch extends MessageManager {
    ...
    private void initViews() {
        ...
        listAll.setLayoutManager(linearLayoutManager);
        dAdapter = new DishAdapter(getContext(), allPostPOJOS);
        listAll.setItemAnimator(new DefaultItemAnimator());
        listAll.setAdapter(dAdapter);
    }
